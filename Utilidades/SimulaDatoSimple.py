# Script para obtener el valor simulado del dato pasado
#
...
# Recibe por parametro tiempo fase semáforo 1
# Recibe por parametro tiempo fase semáforo 2
#
# Crea el fichero en 'route-files' con el númoro de elementos pasados por parámetros
...
def get_new_durations(fase_1, fase_2, num_vehiculos):
    ...
    combination = []
    combination.append(fase_1)
    combination.append(fase_2)
    print(combination)
    var_index = 0
    for phase in phases:
...
parser.add_argument("fase_1", type=int, help="Tiempo fase de semáforo 1.")
parser.add_argument("fase_2", type=int, help="Tiempo fase de semáforo 2.")
...
salva_fichero_original(fichero_red_calles_copia, fichero_red_calles )
...
get_new_durations(args.fase_1, args.fase_2, num_vehiculos )
